package me.bang.springbootweb.resolver;

import me.bang.springbootweb.annotation.SocialUser;
...
public class UserArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    @Override // HandlerMethodArgumentResolver가 해당하는 파라미터를 지원할지 여부를 반환
    public boolean supportsParameter(MethodParameter parameter) {
        return parameter.getParameterAnnotation(SocialUser.class) != null &&
                parameter.getParameterType().equals(User.class);
    }

    @Override // 파라미터의 인자값에 대한 정보를 바탕으로 실제 객체를 생성하여 해당 파라미터 객체에 바인딩
